...
gui.Label3 = Label(
    gui, text="", font=("Arial", 16), width=1, height=1, fg="#000000", bg="#FFFFFF"
)
...
gui.Button1 = Button(
    ...
    height=1,
    fg="#000000",
    command=lambda: runch_folder("Button1"),
    bg="#00FFFF",
)
...
gui.Button2 = Button(
    ...
    height=1,
    fg="#000000",
    command=lambda: runch_folder("Button2"),
    bg="#00FFFF",
)
...
gui.Button3 = Button(
    ...
    height=1,
    fg="#000000",
    command=lambda: runmerge("Button3"),
    bg="#00FFFF",
)
